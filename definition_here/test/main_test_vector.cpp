...
int main()
{
	...
	std::cout << "assign_rang size: " << assign_range.size() << std::endl;
	std::cout << "assign_rang capacity: " << assign_range.capacity() << std::endl;
	for (int i = 0; i < assign_range.size(); i++)
		std::cout << " " << assign_range[i];
	std::cout << std::endl;
	assign_range.assign(10, 5);
	for (int i = 0; i < assign_range.size(); i++)
		std::cout << " " << assign_range[i];
	std::cout << std::endl;
	
	assign_range.assign(BOB.begin() + 1, BOB.end() - 2); //ca leak ici
