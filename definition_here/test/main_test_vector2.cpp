...
//		insert_in_me.push_back(ft::to_std::string(i) + " I love hbaudet\n");
...
//	for (size_t i = 0; i < 15; i++)
//		std_insert_in_me.push_back(ft::to_std::string(i) + " 42 ");
...
//		insert_bis.push_back(ft::to_std::string(3 * i));
...
//	for (size_t i = 0; i < 15; i++)
//		erase_in_me.push_back(ft::to_std::string(2 * i));
